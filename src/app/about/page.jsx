      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              I am a driven software engineer with a strong foundation in
              JavaScript and TypeScript. With over a year of professional
              experience in the field, I have demonstrated a keen ability to
              tackle complex technical challenges and deliver innovative
              solutions. My journey in software engineering began with a passion
              for problem-solving and a fascination with the endless
              possibilities of technology. I also fell in love with world of
              design
            </p>
            {/* BIOGRAPHY QUOTE */}
